...
// newElement.textContent = 'idk';
// newElement.className = 'idk';
// let firstChild = blockElement.firstChild;
// blockElement.insertBefore(newElement, firstChild);

// ///////////////2///////////////

// let heading2 = document.createElement("h2");

// let textNode2 = document.createTextNode("Заголовок H2");
// heading2.appendChild(textNode2);

// let heading1 = document.querySelector("h1");

// heading1.parentNode.insertBefore(heading2, heading1.nextSibling);
...
//     let children = rowElement.children;
...
//   let buttonElement = buttonElements[i];
...
const addProductsObjects = () => {
    products.forEach((item) => {
        ...
        id.classList.add('basket__id');
        title.classList.add('basket__title');
        price.classList.add('basket__price');
        description.classList.add('basket__description');
        category.classList.add('basket__category');
        image.classList.add('basket__image');
        rating.classList.add('basket__rating');
        rate.classList.add('basket__rate');
        ...
        basket.append(title)
        basket.append(price)
        basket.append(description)
        basket.append(category)
        basket.append(image)
        basket.append(rating)
        basket.append(rate)
        basket.append(count)
